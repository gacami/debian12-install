...
# packages needed after installation (compositor, terminal, text editor, launcher, themes ...)
sudo apt install -y picom alacritty rofi qalculate-gtk vim geany geany-plugin-treebrowser nitrogen mpv lxappearance arc-theme 

# other utils
sudo apt install -y udiskie lxpolkit
...
# create folders in user directory (eg. Documents,Downloads...)
